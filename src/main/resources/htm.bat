...
set faf_file_name=%3
set mgra_file_name=%4
set skim_file_name=%5
...
%PYTHON3% run_htm.py %MODEL_DIR% %OUTPUT_DIR% %faf_file_name% %mgra_file_name% %skim_file_name% 2>>%PROJECT_DRIVE%%PROJECT_DIRECTORY%\logFiles\event-htm.txt
